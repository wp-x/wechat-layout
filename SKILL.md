---
name: wechat-layout
command: wechat-layout
description: 全能型微信公众号 AI 排版工具。将任意文本/Markdown 转换为公众号编辑器可直接粘贴的内联样式 HTML。三维组合：8 套配色主题（清新绿/科技蓝/商务黑金/活力橙/优雅紫/中国红/少女粉/极简黑白）× 10 种设计风格（柔和卡片/新粗野主义/蒸汽波/瑞士国际主义/国风雅致/复古终端/孟菲斯/杂志编辑/渐变玻璃感/官网落地页）× 6 种文章类型预设，24+ 组件。
trigger: 当用户提到"公众号排版"、"文章排版"、"转成公众号格式"、"美化文章样式"、"排版这篇文章"、"公众号格式"、"微信排版"时触发
---
